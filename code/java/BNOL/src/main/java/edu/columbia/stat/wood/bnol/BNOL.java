...
public class BNOL {
    ...
    public static void main(String[] args){
        ...
        Pair<int[][], int[]> pair = bnol.generateFromScratch(100000, 1000, 10, 0.2, 0.5, 0.5);

        BNOL b = new BNOL(pair.second(), 1000, 10, 0.2, 0.05, 0.05);
        //b.sampleMachines(1.0);
    ...
    public double sample(double temp){
        ...
        ll_emissions = emissionDistributions.sample(1, temp);

        //ll_words = wordDistribution.sample(temp);

        System.out.println(ll_emissions);
    ...
    private void sampleEmission(int index){
        ...
        // unseat previous data point and seat new
